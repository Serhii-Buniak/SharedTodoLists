...
{
    Task<BatchResponse<TodoListSummary>> GetPageAsync(string userId, int page, int pageSize, bool onlyOwned = false, CancellationToken cancellationToken = default);
    ...
    Task<TodoList> AddUserAsync(string id, string userId, CancellationToken cancellationToken = default);
